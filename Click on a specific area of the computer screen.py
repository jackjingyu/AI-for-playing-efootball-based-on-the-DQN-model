...
time.sleep(2)
#传球
pyautogui.click(626, 346, duration=0.01)
#空传
pyautogui.moveTo(626, 346, duration=0.01)
pyautogui.dragRel(0, -50, duration=0.01)
#直塞球
pyautogui.click(640, 256, duration=0.01)
#直塞传高空球
pyautogui.moveTo(640, 256, duration=0.01)
pyautogui.dragRel(0, -50, duration=0.01)
# 解围
pyautogui.moveTo(720, 230, duration=0.01)
pyautogui.click()
#射门蓄力时间

# 自动射门
pyautogui.moveTo(723, 234, duration=0.01)
pyautogui.click()

# 蓄小力射门
pyautogui.mouseDown(x=723,y=234,button='left',duration=0.01)
time.sleep(0.05)
pyautogui.mouseUp()
# 蓄中力射门
# pyautogui.mouseDown(x=723,y=234,button='left',duration=0.01)
...
# 蓄小力搓射
pyautogui.moveTo(723, 234, duration=0.01)
pyautogui.dragRel(0, 50, duration=0.12)
# 蓄中力搓射
# pyautogui.moveTo(723, 234, duration=0.01)
# pyautogui.dragRel(0, 50, duration=0.15)

# 移动
# 右-d
pyautogui.mouseDown(x=280,y=300,button='left',duration=0.01)
pyautogui.moveTo(300, 300)
# 左-a
pyautogui.mouseDown(x=280,y=300,button='left',duration=0.01)
pyautogui.moveTo(260, 300)
# 上-w
pyautogui.mouseDown(x=280,y=300,button='left',duration=0.01)
...
# pyautogui.dragTo(226, 246, button='left')
# pyautogui.moveTo(326, 346, duration=0.01)
# pyautogui.dragTo(226, 246, button='left')
# pyautogui.click()
